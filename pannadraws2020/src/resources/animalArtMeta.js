const animalArtMeta = {
  ...
  rascals: {
    ...
    prints: 'AVAILABLE',
    buyUrl: '',
    printUrl: 'https://www.etsy.com/ie/listing/870126360/rasclas-bird-art-poster-print-garden',
    merch: [
      {
  ...
  queen_of_the_wasteland: {
    ...
    printUrl: 'https://www.etsy.com/ie/listing/896392438/queen-of-the-wasteland-feathers-of-tales',
    printPrice: 26.95,
    discount: 0,
    discountPrint: 0,
    type: 'watercolour_painting',
  ...
  furcula: {
    ...
    printUrl: 'https://www.etsy.com/ie/listing/889399616/furcula-the-first-feathers-of-tales-vii',
    discount: 0,
    discountPrint: 0,
    type: 'watercolour_painting',
  ...
  the_robin: {
    ...
    printPrice: 21.95,
    buyUrl: '',
    printUrl: 'https://www.etsy.com/ie/listing/839003450/the-robin-feathers-of-tales-v-bird-art',
    discount: 0,
    discountPrint: 0,
    type: 'watercolour_painting',
  ...
  the_fishermans_son: {
    ...
    year: '2020',
    description: 'Ink and watercolour on acrylic paper. 405 x 508 mm (16 x 20 in), 2020.',
    price: 200,
    original: 'AVAILABLE',
    prints: 'AVAILABLE',
    ship: 'FREE_IRL_UK',
  ...
  old_nog: {
    ...
    printUrl: 'https://www.etsy.com/ie/listing/803200144/old-nog-feathers-of-tales-i-bird-art',
    discount: 0,
    discountPrint: 0,
    type: 'watercolour_painting',
  ...
  peacock_girls: {
    ...
    printUrl: 'https://www.etsy.com/ie/listing/805000568/peacock-girls-bird-art-poster-print-bird',
    discount: 0,
    discountPrint: 0,
    type: 'coloured_pencil_drawing',
  ...
  hen_and_rooster: {
    ...
    printUrl: 'https://www.etsy.com/ie/listing/804170108/hen-and-rooster-farmhouse-art-print',
    printPrice: 21.95,
    discount: 0,
    discountPrint: 0,
    type: 'watercolour_painting',
