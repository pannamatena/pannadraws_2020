...
const WeBelong = (props) => {
  const imgData = useStaticQuery(graphql`
    query {
        queryData: file(relativePath: { eq: "2020/we_belong_2020_web.jpg" }) {
          childImageSharp {
            fluid {
   ...
   `);
  const imgMeta = animalArtMeta.we_belong;

  return (
      <Layout>
        <SEO title="We Belong watercolour painting" />
