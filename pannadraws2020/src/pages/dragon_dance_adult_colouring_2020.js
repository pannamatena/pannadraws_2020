...
const DragonDance = (props) => {
  const imgData = useStaticQuery(graphql`
    query {
        queryData: file(relativePath: { eq: "2020/dragon_dance_00_web.jpg" }) {
          childImageSharp {
            fluid {
   ...
   `);
  const imgMeta = adultColouringMeta.dragon_dance;

  return (
      <Layout>
        <SEO title="Dragon Dance - A set of 3 fantasy colouring pages" />
