...
const HenAndRooster = (props) => {
  const imgData = useStaticQuery(graphql`
    query {
        queryData: file(relativePath: { eq: "2020/hen_and_rooster_2020_web.png" }) {
          childImageSharp {
            fluid {
   ...
   `);
  const imgMeta = animalArtMeta.hen_and_rooster;
