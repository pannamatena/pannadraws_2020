...
const TheHug = (props) => {
  const imgData = useStaticQuery(graphql`
    query {
        queryData: file(relativePath: { eq: "2021/the_hug_2021_web.jpg" }) {
          childImageSharp {
            fluid {
   ...
   `);
  const imgMeta = animalArtMeta.the_hug;

  return (
      <Layout>
        <SEO title="The Hug watercolour painting" />
