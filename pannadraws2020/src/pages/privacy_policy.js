...
const AboutPage = () => {
  ...
  <Layout>
    ...
    <div css={style.pageContainer}>
      ...
      <p>The following definitions shall have the same meaning regardless of whether
      ...
      <ul>
        ...
        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to PannaDraws.</li>
        <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
        <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
        <li><strong>Website</strong> refers to PannaDraws, accessible from https://pannadraws.com</li>        <li><strong>Service</strong> refers to the Website.</li>
      ...
      <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain
        ...
        cookies in the <a href="https://www.privacypolicies.com/blog/cookies/">"What Are Cookies"</a> article.</p>
      ...
      <ul>
        <li>
          ...
          <p>The Facebook pixel is an analytics tool that allows you to measure the effectiveness of your advertising by understanding the actions people take on your website. Read their privacy policy here: <a href="https://www.facebook.com/policy.php">https://www.facebook.com/policy.php</a></p>
        </li>
      </ul>
      ...
      <ul>
        <li>By email: pannarajzol.design@gmail.com</li>
      </ul>
    </div>
  </Layout>
)};
