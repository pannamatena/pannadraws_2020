...
const QueenOfHearts = (props) => {
  const imgData = useStaticQuery(graphql`
    query {
        queryData: file(relativePath: { eq: "2021/queen_of_hearts_2021_web.jpg" }) {
          childImageSharp {
            fluid {
   ...
   `);
  const imgMeta = animalArtMeta.queen_of_hearts;

  return (
      <Layout>
        <SEO title="Queen of Hearts swans and swallows watercolour painting" />
